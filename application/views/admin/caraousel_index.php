        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
                <div class="form-group ic-cmp-int float-lb floating-lb">
                    ...
                    <div class="nk-int-st">
                        <label for="foto" class="form-label">Pilih Foto dengan ukuran (16 : 9)</label>
...
<div class="data-table-list">
	...
	<div class="table-responsive">
		<table id="data-table-basic" class="table table-striped">
			...
			<tbody>
				<?php foreach($caraousel as $gg) { ?>
				<tr>
					<td><?= $gg['judul'] ?></td>
                    <td><?= $gg['deskripsi'] ?></td>

					<td><a href="<?= base_url('assets/upload/caraousel/'.$gg['foto']) ?>" target="_blank">
							...
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a href="<?= site_url('admin/caraousel/delete_data/' . $gg['foto']); ?>"
